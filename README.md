...
<style>
  header {
  background-image: url(picture/hero-section.webp);
  height: 840px;
}
header nav div {
  padding: 10px;
...
header nav div ul li .butten {
  background-color: #1eb35b;
  padding: 10px;
  border-radius: 10px;
}
header nav div ul li .butten img {
  width: 5%;
}
header nav div ul li .empity {
  width: 216px;
}
header nav div ul li .icon {
  width: 24px;
}
header nav div ul li .icon-svg {
  width: 24px;
}
            ...
            <div class="container">
                ...
                <a class="navbar-brand" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="absolute right-0 left-0 mx-auto md:static h-11 md:h-10 lg:h-14 shrink-0"
                ...
                <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
                    <ul class="navbar-nav justify-content-center align-items-center right">
                        ...
                        <li class="end">
                            <img class="icon" src="picture/icons8-moon-96.png" alt="">
                        </li>
                        <li class="shop end">
                            <img class="icon-svg" src="picture/shopping-bag-svgrepo-com.svg" alt="">
                        </li>
                        <li >
                            <a href="#" class="butten">
                                <img src="picture/user-svgrepo-com.svg" alt="">
                                ورود|عضویت
                            </a>
                        </li>
                    </ul>
